...
blist = [50,250,500,1000,5000,10000,20000,50000,100000]

# this means 500 should be an elevation fluctuation of 10.47 (worked)
# 200 should be elevation fluctation of 4.18 (worked)
# 100 should be elevation fluctaution of 2.09 (totally worked)
# so as is, b is not a cm value but just  anumber ... 
# compute all parameter sets 
paramslist = []
